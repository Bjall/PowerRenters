...
CREATE TABLE veh_porte(
        ...
        veh_porte_libelle Varchar (50) NOT NULL ,
        PRIMARY KEY (veh_porte_id )
)ENGINE=InnoDB;


#------------------------------------------------------------
# Table: veh_type_carburant
#------------------------------------------------------------
...
CREATE TABLE vehm_modele(
        ...
        vehmmod_libelle Varchar (50) NOT NULL ,
...
CREATE TABLE Vehicule(
        ...
        veh_boite_id   Int NOT NULL ,
        vehm_carb_id   Int NOT NULL ,
        veh_coul_id    Int NOT NULL ,
        vehmmod_id     Int NOT NULL ,
        veh_porte_id   Int NOT NULL ,
...
CREATE TABLE entretien(
        ...
        entr_statut  Varchar (50) NOT NULL ,
...
CREATE TABLE Penalites(
        idLibellePenalite int (11) Auto_increment  NOT NULL ,
        LIbellePenalite   Varchar (25) ,
        Forfait           Float ,
        Coefficient       Float ,
        PRIMARY KEY (idLibellePenalite )
)ENGINE=InnoDB;
...
CREATE TABLE sensuivre(
        ...
        PRIMARY KEY (stat_id ,etat_des_lieux_id ,element_id )
)ENGINE=InnoDB;
...
CREATE TABLE etatducontrat(
        statut_cont_id Int NOT NULL ,
        contrat_id     Int NOT NULL ,
        PRIMARY KEY (statut_cont_id ,contrat_id )
)ENGINE=InnoDB;
...
CREATE TABLE relation3(
        contrat_id        Int NOT NULL ,
        idLibellePenalite Int NOT NULL ,
        PRIMARY KEY (contrat_id ,idLibellePenalite )
)ENGINE=InnoDB;
...
ALTER TABLE contratdelocation ADD CONSTRAINT FK_contratdelocation_tva_id FOREIGN KEY (tva_id) REFERENCES _tva_(tva_id);
...
ALTER TABLE statut_etat_des_lieux ADD CONSTRAINT FK_statut_etat_des_lieux_entr_id FOREIGN KEY (entr_id) REFERENCES entretien(entr_id);
...
ALTER TABLE sensuivre ADD CONSTRAINT FK_sensuivre_stat_id FOREIGN KEY (stat_id) REFERENCES statut_etat_des_lieux(stat_id);
...
ALTER TABLE etatducontrat ADD CONSTRAINT FK_etatducontrat_statut_cont_id FOREIGN KEY (statut_cont_id) REFERENCES statut_contrat(statut_cont_id);
ALTER TABLE etatducontrat ADD CONSTRAINT FK_etatducontrat_contrat_id FOREIGN KEY (contrat_id) REFERENCES contratdelocation(contrat_id);
ALTER TABLE relation3 ADD CONSTRAINT FK_relation3_contrat_id FOREIGN KEY (contrat_id) REFERENCES contratdelocation(contrat_id);
ALTER TABLE relation3 ADD CONSTRAINT FK_relation3_idLibellePenalite FOREIGN KEY (idLibellePenalite) REFERENCES Penalites(idLibellePenalite);
