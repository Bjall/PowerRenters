...
CREATE TABLE statut_etat_des_lieux(
        stat_etat__id     int (11) Auto_increment  NOT NULL ,
        stat_etat_libelle Varchar (25) NOT NULL ,
        PRIMARY KEY (stat_etat__id )
)ENGINE=InnoDB;
...
CREATE TABLE sensuivre(
        ...
        PRIMARY KEY (stat_etat__id ,etat_des_lieux_id ,element_id )
)ENGINE=InnoDB;
...
ALTER TABLE entretien ADD CONSTRAINT FK_entretien_stat_etat__id FOREIGN KEY (stat_etat__id) REFERENCES statut_etat_des_lieux(stat_etat__id);
...
ALTER TABLE sensuivre ADD CONSTRAINT FK_sensuivre_stat_etat__id FOREIGN KEY (stat_etat__id) REFERENCES statut_etat_des_lieux(stat_etat__id);
