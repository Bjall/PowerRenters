...
<html>
	...
	<body>
		...
		<section class="container">
			<article>
				<header><h1>Notre agence</h1></header>
				<img src="/PowerRenters/images/power.jpg" alt="image article" class="firstimage"/>
				<p>Power Rangers est une franchise de médias américaine fondée sur une équipe de super-héros. Les Power Rangers sont adaptées des séries japonaises Super sentai, les producteurs américains rachetant les droits d'utilisation des images et les costumes aux producteurs japonais.
				...
				Elle a été la propriété de la Walt Disney Company1,2,3 de 2001 à 2010 avant de revenir dans le giron d'Haim Saban4.</p>

				<h1>Bientôt d'autres agences !</h1>
				<img src="/PowerRenters/images/green.jpg" alt="image article" class="secondimage"/>
				<p>
